...
public class Buy extends Trade {
    public Buy(UUID id, ZonedDateTime date, TransactionType transactionType, AmountInCurrency baseAmount, String notes, String exchange, AmountInCurrency quoteAmount, AmountInCurrency fee, AmountInCurrency totalCost) {
